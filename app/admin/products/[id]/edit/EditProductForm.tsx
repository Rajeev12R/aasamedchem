...
export default function EditProductForm({ product }: { product: SerializedProduct }) {
  ...
  const [form, setForm] = useState({
    ...
    quantity: product.inventoryQuantity, // Starts in base unit
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-hidden"
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            className="border rounded-lg px-3 py-2 min-h-[80px] focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-hidden"
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="border rounded-lg px-3 py-2 flex-1 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-hidden"
            />
            <select
              value={form.unit}
              onChange={(e) => setForm((f) => ({ ...f, unit: e.target.value }))}
              className="border rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500/20 outline-hidden text-sm"
            >
        ...
        <div className="flex gap-3 mt-4">
          <button
            type="submit"
            disabled={loading}
            className="bg-blue-600 text-white font-semibold px-6 py-2.5 rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors text-sm"
          >
